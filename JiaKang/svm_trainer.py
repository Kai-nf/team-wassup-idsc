...
VERSION_CONFIG = {
    ...
    "v3.2": {
        "wavelet_path":  THIS_DIR / "JiaKang" / "dataset_v3.2_wavelet.npy",
        "manifest_path": THIS_DIR / "JiaKang" / "fold_composition_v3.2.json",
        "output_file":   "svm_ablation_v3.2.json",
        "split_source":  "fold_composition_v3.2.json",
        "data_format":   "tensor_npy_with_json",
    },
    "v4": {
        "wavelet_path":  THIS_DIR / "Steve" / "dataset_v4_features_drop14.csv",
        "manifest_path": THIS_DIR / "Steve" / "fold_composition_v4_drop14.json",
        "output_file":   "svm_ablation_v4.json",
